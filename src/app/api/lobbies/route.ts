  ...
  global._spycam_lobbies = [
    {
      ...
      members: [
        ...
        },
        {
          ...
          roles: ['Contrôleur'],
          isLeader: false,
          avatarUrl: 'https://media.valorant-api.com/playercards/7e1586a9-4674-8848-038c-cfbc702330a1/smallart.png',
        },
      ],
      voiceMembers: [
        {
      ...
      chat: [
        {
          ...
          senderName: 'Shadow',
          senderTag: 'BETA',
          senderAvatar: 'https://media.valorant-api.com/playercards/9fb348bc-41a0-91ad-8a3e-818035c4e561/smallart.png',
    ...
    },
    {
      ...
      leaderRankTier: 16,
      isLeaderPrivate: false,
      leaderAvatar: 'https://media.valorant-api.com/playercards/33296839-4467-9c02-e224-3490710ce123/smallart.png',
      members: [
        {
          id: 'mem_3',
          gameName: 'Kyojin',
          ...
          roles: ['Duelliste'],
          isLeader: true,
          avatarUrl: 'https://media.valorant-api.com/playercards/33296839-4467-9c02-e224-3490710ce123/smallart.png',
        },
        {
          id: 'mem_4',
          gameName: 'Ghosty',
          ...
          isLeader: false,
          avatarUrl: 'https://media.valorant-api.com/playercards/e979a0b2-4d04-3a56-4b4e-4fbc11f32a56/smallart.png',
        },
      ],
      voiceMembers: [],
      voiceTranscripts: [],
    ...
    },
    {
      ...
      leaderTag: 'VAL',
      leaderRank: 'Radiant',
      leaderRankUrl: 'https://media.valorant-api.com/competitivetiers/03621f52-342b-cf4e-4f86-9350a49c6d04/27/largeicon.png',
      leaderRankTier: 27,
      isLeaderPrivate: false,
      leaderAvatar: 'https://media.valorant-api.com/playercards/c189b88e-49b8-b4b1-4f10-b99611ad1b26/smallart.png',
      members: [
        {
          id: 'mem_5',
          gameName: 'Aura',
          tagLine: 'VAL',
          rank: 'Radiant',
          rankUrl: 'https://media.valorant-api.com/competitivetiers/03621f52-342b-cf4e-4f86-9350a49c6d04/27/largeicon.png',
          rankTier: 27,
          isPrivateRank: false,
          roles: ['Duelliste'],
          isLeader: true,
          avatarUrl: 'https://media.valorant-api.com/playercards/c189b88e-49b8-b4b1-4f10-b99611ad1b26/smallart.png',
        },
      ],
      voiceMembers: [],
      voiceTranscripts: [],
      mode: 'Premier / Tournoi',
      roleNeeded: ['Tous Rôles'],
      micRequired: 'yes',
      maxSlots: 5,
      currentSlots: 1,
      note: 'Team Premier Div 5 cherche 4e et 5e joueur sérieux avec micro et comms calmes.',
