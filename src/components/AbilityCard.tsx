          ...
          <div style={{ display: activeTab === 'video' ? 'block' : 'none' }} className="animate-in fade-in duration-300">
            <div className="relative w-full aspect-video bg-black rounded-lg overflow-hidden border border-white/10 group">
              ...
              {ability.videos!.length > 1 && (
                <>
                  <button
                    ...
                    className="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 bg-black/60 rounded-full flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-opacity hover:bg-[#fa4454] hover:text-white border border-white/20 z-40"
                  >
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 bg-black/60 rounded-full flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-opacity hover:bg-[#fa4454] hover:text-white border border-white/20 z-40"
                  >
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6">
              ...
              <div className="absolute top-4 left-4 pointer-events-none z-20 flex items-center gap-2">
                <span className="bg-black/60 backdrop-blur-md px-3 py-1 rounded-md text-white font-bold text-xs tracking-wider border border-white/10 uppercase">
                ...
                {currentVideo?.description && !isDescriptionExpanded && (
                  <button
                    ...
                    className="pointer-events-auto flex items-center gap-1 text-[11px] font-bold uppercase tracking-widest text-white/90 hover:text-white bg-black/60 hover:bg-[#fa4454] px-3 py-1 rounded-md backdrop-blur-md transition-colors border border-white/10"
                  >
                    {tr("En savoir plus")}
